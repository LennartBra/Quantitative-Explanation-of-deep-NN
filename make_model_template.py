...
def make_model_pressure_multi_900():
    #Define Inputs
    inp_time0 = Input(shape=(900, 1), name="input_time0")
    inp_time1 = Input(shape=(900, 1), name="input_time1")
    inp_time2 = Input(shape=(900, 1), name="input_time2")
    ...
    model = keras.Model(inputs=[inp_time0,
                                ...
                                inp_time2],
                                outputs=final_outp,
                                name='Template_Model_Pressure_900')
